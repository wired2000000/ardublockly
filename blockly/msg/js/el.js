...
Blockly.Msg.ARD_CONFIGURE_INSTRUMENT = "Ρύθμιση μουσικού οργάνου";
...
Blockly.Msg.ARD_DURATION = "διάρκεια";
Blockly.Msg.ARD_EIGHTH = "όγδοο";
Blockly.Msg.ARD_FLAT = "ύφεση";
...
Blockly.Msg.ARD_HALF = "μισό";
Blockly.Msg.ARD_HIGH = "ΠΑΝΩ";
...
Blockly.Msg.ARD_OCTAVE = "οκτάβα";
Blockly.Msg.ARD_OF = "με";
Blockly.Msg.ARD_PIN = "ακίδα";
Blockly.Msg.ARD_PIN_WARN1 = "Pin %1 is needed for %2 as pin %3. Already used as %4.";
Blockly.Msg.ARD_PLAY = "Παίξε";
Blockly.Msg.ARD_POINT = "Παρ/νο ;";
...
Blockly.Msg.ARD_QUARTER = "τέταρτο";
Blockly.Msg.ARD_REST = "Παύση";
Blockly.Msg.ARD_RYTHM = "ρυθμός";
...
Blockly.Msg.ARD_SET_AT = "Όρισε στο";
Blockly.Msg.ARD_SHARP = "δίεση";
Blockly.Msg.ARD_SIXTEENTH = "δέκατο έκτο";
...
Blockly.Msg.ARD_TABLE = "Πίνακας";
Blockly.Msg.ARD_THE_VALUE = "την τιμή";
Blockly.Msg.ARD_THIRTY_SECOND = "τριακοστό δεύτερο";
...
Blockly.Msg.ARD_TYPE_ARRAY = "Πίνακας";
Blockly.Msg.ARD_TYPE_BOOL = "Boolean";
Blockly.Msg.ARD_TYPE_CHAR = "Χαρακτήρας";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";
Blockly.Msg.ARD_TYPE_DECIMAL = "Δεκαδικός";
Blockly.Msg.ARD_TYPE_LONG = "Large Ακέραιος";
Blockly.Msg.ARD_TYPE_NULL = "Null";
Blockly.Msg.ARD_TYPE_NUMBER = "Ακέραιος";
Blockly.Msg.ARD_TYPE_SHORT = "Short Ακέραιος";
Blockly.Msg.ARD_TYPE_TEXT = "Κείμενο";
Blockly.Msg.ARD_TYPE_UNDEF = "Undefined";
Blockly.Msg.ARD_VAR_AS = "as";
Blockly.Msg.ARD_VAR_AS_TIP = "Sets a value to a specific type";
Blockly.Msg.ARD_WHOLE = "ολόκληρο";
